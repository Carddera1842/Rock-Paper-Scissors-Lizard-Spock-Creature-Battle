    ...
    public static void main(String[] args) {
        ...
        while (gameRunning) {
            ...
            if (playerCreatures.size() == 1) {
                ...
                selectedPlayerCreature = playerCreatures.get(0);

                System.out.println("\n" + selectedPlayerCreature.getCreature().getName() + " will battle for you!");
                ...
                for (int i = 0; i < playerCreatures.size(); i++) {
                    ...
                    PlayerCreature owned = playerCreatures.get(i);

                    Creature creature = owned.getCreature();

                    System.out.println((i + 1) + ". " + creature.getName() + " [" + creature.getType() + "]" + " | Level: " + owned.getLevel() + " | XP: " + owned.getExperience() + " | W: " + owned.getWins() + " | L: " + owned.getLosses());
                }

                System.out.print("\nChoose your creature: ");

                int creatureChoice = scanner.nextInt();

                scanner.nextLine();

                while (creatureChoice < 1 || creatureChoice > playerCreatures.size()) {

                    System.out.print("Invalid choice. Choose 1-" + playerCreatures.size() + ": ");
                ...
                selectedPlayerCreature = playerCreatures.get(creatureChoice - 1);
            }
            ...
            Creature playerCreature = selectedPlayerCreature.getCreature();
            ...
            if (playerCreature.getSpeed() > computerCreature.getSpeed()) {

                System.out.println("\nYour " + playerCreature.getName() + " is faster!");

            } else if (computerCreature.getSpeed() > playerCreature.getSpeed()) {

                System.out.println("\nOpponent's " + computerCreature.getName() + " is faster!");
            ...
            while (!player.isFainted() && !computer.isFainted()) {
                ...
                while (moveChoice < 1 || moveChoice > playerMoves.size()) {
                ...
                if (playerGoesFirst) {
                    ...
                    battleService.executeMove(player, computer, playerMove, true);

                    if (!computer.isFainted()) {

                        battleService.executeMove(computer, player, computerMove, false);
                    }
                ...
                if (!player.isFainted()) {
                    ...
                    if (player.isPoisoned()) {
                        ...
                        System.out.println("\nYour " + playerCreature.getName() + " took " + player.getPoisonDamage() + " poison damage!");
                    }
                }
                ...
                if (!computer.isFainted()) {
                    ...
                    if (computer.isPoisoned()) {
                        ...
                        System.out.println("Opponent's " + computerCreature.getName() + " took " + computer.getPoisonDamage() + " poison damage!");
                    }
                }
            }
            ...
            if (!player.isFainted()) {
                ...
                int levelsGained = selectedPlayerCreature.checkForLevelUps();

                if (levelsGained > 0) {

                    System.out.println(playerCreature.getName() + " reached Level " + selectedPlayerCreature.getLevel() + "!");
                }

                playerCreatureRepository.updateProgress(selectedPlayerCreature);

                System.out.println("\n" + playerCreature.getName() + " gained " + xpEarned + " XP!");
            ...
            System.out.println("1. Battle Again");
            ...
            if (continueChoice == 2) {
                ...
                System.out.println("\nThanks for playing, " + currentPlayer.getUsername() + "!");
            }
        }
        scanner.close();
    }
